    ...
    _setupListeners(peerConnection) {
      ...
      peerConnection.oniceconnectionstatechange = () => {
        switch (peerConnection.iceConnectionState) {
          ...
          case "connected":
            logger_default.log(
              "iceConnectionState changed to connected on the connection with " + peerId
            );
            break;
          case "disconnected":
            logger_default.log(
          ...
          case "completed":
            logger_default.log(
              "iceConnectionState changed to completed on the connection with " + peerId
            );
    ...
    handleCandidate(ice) {
      return __async(this, null, function* () {
        ...
        try {
          ...
          yield peerConnection.addIceCandidate(
            new ctr({
              sdpMid,
              sdpMLineIndex,
              candidate
        ...
        try {
          ...
          if (response.status !== 200) {
            if (response.status === 401) {
              ...
              throw new Error(
                "It doesn't look like you have permission to list peers IDs. " + helpfulError
              );
            }
            throw new Error(`Error. Status:${response.status}`);
          }
